...
class CarBillReportPage extends StatefulWidget {
  const CarBillReportPage({super.key});

  @override
  State<CarBillReportPage> createState() => _CarBillReportPageState();
}

class _CarBillReportPageState extends State<CarBillReportPage> {
  ...
  _fetchAllBills() async {
    try {
      allBills = await CarBillService().fetchAllCarBills();
      setState(() {
  ...
  _filterBillsByDateRange(DateTime start, DateTime end) {
    setState(() {
      filteredBills = allBills.where((bill) {
        DateTime? billDate = bill.carPolicy.date;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Car Bill Report'),
        centerTitle: true,
